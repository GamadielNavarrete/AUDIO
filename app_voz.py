"""
Puente Streamlit <-> servicio de voz
--------------------------------
Genera audios TTS a través de un servicio externo y los descarga con el nombre
que vos elijas (por defecto, numerados: 1.mp3, 2.mp3, 3.mp3, ...).

Cómo correrlo:
    pip install streamlit requests
    streamlit run app_voz.py

Necesitás tu clave de acceso al servicio (se configura como API Key).
"""
...
# ---------------------------------------------------------------------------
# Utilidades del servicio de voz
# ---------------------------------------------------------------------------
...
def generate_audio(api_key: str, voice_id: str, text: str, model_id: str,
    ...
    """Llama a la API del servicio y devuelve los bytes del mp3 generado."""
